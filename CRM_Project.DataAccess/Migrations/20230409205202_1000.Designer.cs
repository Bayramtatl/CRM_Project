            ...
            modelBuilder.Entity("CRM_Project.Core.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "k@k.com",
                            Password = "123",
                            UpdatedDate = new DateTime(2023, 4, 9, 23, 52, 2, 664, DateTimeKind.Local).AddTicks(4481)
                        });
                });
            ...
            modelBuilder.Entity("CRM_Project.Core.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ServiceStatus = 0,
                            UpdatedDate = new DateTime(2023, 4, 9, 23, 52, 2, 664, DateTimeKind.Local).AddTicks(4499)
                        });
                });
            ...
            modelBuilder.Entity("CRM_Project.Core.Entities.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = 0,
                            Surname = "Tatlı",
                            UpdatedDate = new DateTime(2023, 4, 9, 23, 52, 2, 664, DateTimeKind.Local).AddTicks(4380)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Role = 0,
                            Surname = "Talebi",
                            UpdatedDate = new DateTime(2023, 4, 9, 23, 52, 2, 664, DateTimeKind.Local).AddTicks(4390)
                        });
                });
